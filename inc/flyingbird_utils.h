...
#ifndef __flyingbird_utils_H__
#define __flyingbird_utils_H__
...
void rotate_xyz(float* result, const float angle, float x, float y, float z);

void rotateZ(float* result, float angle);
