...
Callstack Information (PID:10792)
Call Stack Count: 21
...
D/RESOURCED( 2356): proc-noti.c: recv_str(87) > [recv_str,87] str is null
...
04-01 21:09:08.388+0900 W/CRASH_MANAGER(10653): worker.c: worker_job(1189) > 1110648666c791459512548
04-01 21:09:09.258+0900 D/PKGMGR_INFO(10653): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_filter_count(3078) > [SECURE_LOG] where = package_app_info.app_exec='/opt/usr/apps/org.exelim.flyingbird/bin/flyingbird' and package_app_info.app_disable IN ('false','False')
04-01 21:09:09.258+0900 D/PKGMGR_INFO(10653): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_filter_count(3084) > [SECURE_LOG] query = select DISTINCT package_app_info.app_id, package_app_info.app_component, package_app_info.app_installed_storage from package_app_info LEFT OUTER JOIN package_app_localized_info ON package_app_info.app_id=package_app_localized_info.app_id and package_app_localized_info.app_locale='en-gb' LEFT OUTER JOIN package_app_app_svc ON package_app_info.app_id=package_app_app_svc.app_id LEFT OUTER JOIN package_app_app_category ON package_app_info.app_id=package_app_app_category.app_id where package_app_info.app_exec='/opt/usr/apps/org.exelim.flyingbird/bin/flyingbird' and package_app_info.app_disable IN ('false','False')
04-01 21:09:09.258+0900 D/PKGMGR_INFO(10653): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_filter_foreach_appinfo(3193) > [SECURE_LOG] where = package_app_info.app_exec='/opt/usr/apps/org.exelim.flyingbird/bin/flyingbird' and package_app_info.app_disable IN ('false','False')
...
04-01 21:09:09.278+0900 D/PKGMGR_INFO(10653): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_filter_foreach_appinfo(3193) > [SECURE_LOG] where = package_app_info.app_exec='/opt/usr/apps/org.exelim.flyingbird/bin/flyingbird' and package_app_info.app_disable IN ('false','False')
04-01 21:09:09.278+0900 D/PKGMGR_INFO(10653): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_filter_foreach_appinfo(3199) > [SECURE_LOG] query = select DISTINCT package_app_info.*, package_app_localized_info.app_locale, package_app_localized_info.app_label, package_app_localized_info.app_icon from package_app_info LEFT OUTER JOIN package_app_localized_info ON package_app_info.app_id=package_app_localized_info.app_id and package_app_localized_info.app_locale IN ('No Locale', 'en-gb') LEFT OUTER JOIN package_app_app_svc ON package_app_info.app_id=package_app_app_svc.app_id LEFT OUTER JOIN package_app_app_category ON package_app_info.app_id=package_app_app_category.app_id where package_app_info.app_exec='/opt/usr/apps/org.exelim.flyingbird/bin/flyingbird' and package_app_info.app_disable IN ('false','False')
04-01 21:09:09.358+0900 D/AUL     (10674): launch.c: app_request_to_launchpad(281) > [SECURE_LOG] launch request : org.tizen.crash-popup
04-01 21:09:09.358+0900 D/AUL     (10674): app_sock.c: __app_send_raw(265) > pid(-2) : cmd(0)
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_request.c: __request_handler(495) > __request_handler: 0
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_request.c: __request_handler(540) > launch a single-instance appid: org.tizen.crash-popup
04-01 21:09:09.358+0900 D/AUL     ( 2105): pkginfo.c: aul_app_get_appid_bypid(205) > second change pgid = 2067, pid = 10674
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_launch.c: _start_app(1479) > [SECURE_LOG] caller : (null)
04-01 21:09:09.358+0900 D/RESOURCED( 2356): proc-noti.c: recv_str(87) > [recv_str,87] str is null
04-01 21:09:09.358+0900 D/RESOURCED( 2356): proc-noti.c: process_message(169) > [process_message,169] process message caller pid 2105
04-01 21:09:09.358+0900 D/RESOURCED( 2356): proc-main.c: resourced_proc_action(669) > [SECURE_LOG] [resourced_proc_action,669] appid org.tizen.crash-popup, pid 10522, type 5 
04-01 21:09:09.358+0900 D/RESOURCED( 2356): proc-main.c: resourced_proc_status_change(592) > [SECURE_LOG] [resourced_proc_status_change,592] resume request 10522
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_launch.c: __nofork_processing(1008) > __nofork_processing, cmd: 0, pid: 10522
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_launch.c: __nofork_processing(1024) > fake launch pid : 10522
04-01 21:09:09.358+0900 D/AUL     ( 2105): app_sock.c: __app_send_raw_with_delay_reply(435) > pid(10522) : cmd(0)
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_launch.c: __set_reply_handler(873) > listen fd : 28, send fd : 27
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_launch.c: __nofork_processing(1027) > fake launch done
04-01 21:09:09.358+0900 D/APP_CORE(10522): appcore.c: __aul_handler(423) > [APP 10522]     AUL event: AUL_START
04-01 21:09:09.358+0900 D/APP_CORE(10522): appcore-efl.c: __do_app(470) > [APP 10522] Event: RESET State: RUNNING
04-01 21:09:09.358+0900 D/APP_CORE(10522): appcore-efl.c: __do_app(496) > [APP 10522] RESET
04-01 21:09:09.358+0900 D/LAUNCH  (10522): appcore-efl.c: __do_app(498) > [crash-popup:Application:reset:start]
04-01 21:09:09.358+0900 D/AUL_AMD ( 2105): amd_launch.c: __reply_handler(784) > listen fd(28) , send fd(27), pid(10522), cmd(0)
04-01 21:09:09.358+0900 D/LAUNCH  (10522): appcore-efl.c: __do_app(501) > [crash-popup:Application:reset:done]
04-01 21:09:09.358+0900 I/APP_CORE(10522): appcore-efl.c: __do_app(514) > Legacy lifecycle: 0
04-01 21:09:09.358+0900 I/APP_CORE(10522): appcore-efl.c: __do_app(516) > [APP 10522] App already running, raise the window
04-01 21:09:09.358+0900 D/APP_CORE(10522): appcore.c: __aul_handler(426) > [SECURE_LOG] caller_appid : (null)
04-01 21:09:09.358+0900 D/APP_CORE(10522): appcore.c: __prt_ltime(183) > [APP 10522] first idle after reset: 58421 msec
04-01 21:09:09.358+0900 D/AUL     (10674): launch.c: app_request_to_launchpad(295) > launch request result : 10522
04-01 21:09:10.188+0900 D/AUL_AMD ( 2105): amd_launch.c: __e17_status_handler(1911) > pid(2236) status(3)
04-01 21:09:10.188+0900 D/RESOURCED( 2356): proc-monitor.c: proc_dbus_proc_signal_handler(198) > [proc_dbus_proc_signal_handler,198] call proc_dbus_proc_signal_handler : pid = 2236, type = 0
04-01 21:09:10.188+0900 D/RESOURCED( 2356): proc-main.c: resourced_proc_status_change(555) > [SECURE_LOG] [resourced_proc_status_change,555] set foreground : 2236
04-01 21:09:10.188+0900 E/RESOURCED( 2356): proc-main.c: proc_update_process_state(233) > [proc_update_process_state,233] Current pid (2236) didn't have any process list
04-01 21:09:10.188+0900 D/RESOURCED( 2356): cpu.c: cpu_foreground_state(92) > [cpu_foreground_state,92] cpu_foreground_state : pid = 2236, appname = (null)
04-01 21:09:10.188+0900 D/RESOURCED( 2356): cgroup.c: cgroup_write_node(91) > [SECURE_LOG] [cgroup_write_node,91] cgroup_buf /sys/fs/cgroup/cpu/cgroup.procs, value 2236
04-01 21:09:10.268+0900 W/W_HOME  ( 2236): main.c: _window_visibility_cb(796) > Window [0x1600003] is now visible(0)
04-01 21:09:10.268+0900 D/APP_CORE( 2236): appcore-efl.c: __update_win(718) > [EVENT_TEST][EVENT] __update_win WIN:1600003 fully_obscured 0
04-01 21:09:10.268+0900 D/APP_CORE( 2236): appcore-efl.c: __visibility_cb(884) > bvisibility 1, b_active 0
04-01 21:09:10.268+0900 D/APP_CORE( 2236): appcore-efl.c: __visibility_cb(887) >  Go to Resume state
04-01 21:09:10.358+0900 D/AUL_AMD ( 2105): amd_request.c: __add_history_handler(247) > [SECURE_LOG] add rua history org.tizen.crash-popup /usr/apps/org.tizen.crash-popup/bin/crash-popup
04-01 21:09:10.358+0900 D/RUA     ( 2105): rua.c: rua_add_history(179) > rua_add_history start
04-01 21:09:10.368+0900 D/RUA     ( 2105): rua.c: rua_add_history(247) > rua_add_history ok
04-01 21:09:39.808+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: main(1436) > server start
04-01 21:09:39.808+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: main(1505) > Main loop is created.
04-01 21:09:39.808+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkg_mgr_object_class_init(144) > called
04-01 21:09:39.808+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkg_mgr_object_class_init(155) > done
04-01 21:09:39.808+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkg_mgr_object_init(93) > called
04-01 21:09:39.818+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkg_mgr_object_init(130) > RequestName returns: 1
04-01 21:09:39.818+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkg_mgr_object_init(135) > Ready to serve requests
04-01 21:09:39.818+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkg_mgr_object_init(139) > done
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: main(1510) > pkg_mgr object is created, and request callback is registered.
04-01 21:09:39.818+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkgmgr_request(194) > Called
04-01 21:09:39.818+0900 D/PKGMGR  (10734): comm_pkg_mgr_server.c: pkgmgr_request(203) > [SECURE_LOG] Call request callback(obj, org.exelim.flyingbird_1088240695, 11, rpm, org.exelim.flyingbird, , *ret)
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: req_cb(431) > [SECURE_LOG] >> in callback >> Got request: [org.exelim.flyingbird_1088240695] [11] [rpm] [org.exelim.flyingbird] [] []
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: __register_signal_handler(382) > signal: SIGCHLD succeed
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: __register_signal_handler(384) > g_timeout_add_seconds() Added to Main Loop
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: req_cb(450) > req_type=(11)  backend_flag=(0)
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: queue_job(1168) > saved queue status. Now try fork()
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: queue_job(1175) > child forked [10735] for request type [11]
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: queue_job(1347) > parent exit
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10735): pkgmgr-server.c: queue_job(1175) > child forked [0] for request type [11]
04-01 21:09:39.818+0900 D/PKGMGR_SERVER(10735): pkgmgr-server.c: __make_pid_info_file(825) > File path = /tmp/org.exelim.flyingbird
04-01 21:09:39.838+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: sighandler(326) > child exit [10735]
04-01 21:09:39.838+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: sighandler(341) > child NORMAL exit [10735]
04-01 21:09:41.998+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: exit_server(724) > exit_server Start
04-01 21:09:41.998+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: main(1516) > Quit main loop.
04-01 21:09:41.998+0900 D/PKGMGR_SERVER(10734): pkgmgr-server.c: main(1524) > package manager server terminated.
04-01 21:09:43.038+0900 D/AUL_AMD ( 2105): amd_request.c: __request_handler(495) > __request_handler: 0
04-01 21:09:43.038+0900 D/AUL_AMD ( 2105): amd_request.c: __request_handler(540) > launch a single-instance appid: org.exelim.flyingbird
04-01 21:09:43.038+0900 D/AUL     ( 2105): pkginfo.c: aul_app_get_appid_bypid(205) > second change pgid = 10787, pid = 10789
04-01 21:09:43.038+0900 D/AUL_AMD ( 2105): amd_launch.c: _start_app(1479) > [SECURE_LOG] caller : (null)
04-01 21:09:43.038+0900 D/AUL_AMD ( 2105): amd_launch.c: __set_appinfo_for_launchpad(1950) > Add hwacc, taskmanage, app_path and pkg_type into bundle for sending those to launchpad.
04-01 21:09:43.038+0900 D/AUL     ( 2105): app_sock.c: __app_send_raw(265) > pid(-4) : cmd(0)
04-01 21:09:43.138+0900 E/AUL_PAD ( 2136): launchpad.c: __launchpad_main_loop(1177) > faild to get app pid
04-01 21:09:43.138+0900 D/AUL     ( 2105): simple_util.c: __trm_app_info_send_socket(261) > __trm_app_info_send_socket
04-01 21:09:43.138+0900 E/AUL     ( 2105): simple_util.c: __trm_app_info_send_socket(264) > access
04-01 21:09:43.138+0900 D/RESOURCED( 2356): proc-noti.c: recv_str(87) > [recv_str,87] str is null
04-01 21:09:43.138+0900 D/RESOURCED( 2356): proc-noti.c: process_message(169) > [process_message,169] process message caller pid 2105
04-01 21:09:43.138+0900 D/RESOURCED( 2356): proc-main.c: resourced_proc_action(669) > [SECURE_LOG] [resourced_proc_action,669] appid org.exelim.flyingbird, pid 10790, type 4 
04-01 21:09:43.138+0900 D/RESOURCED( 2356): proc-main.c: resourced_proc_status_change(570) > [SECURE_LOG] [resourced_proc_status_change,570] launch request org.exelim.flyingbird, 10790
04-01 21:09:43.138+0900 D/RESOURCED( 2356): proc-main.c: resourced_proc_status_change(572) > [SECURE_LOG] [resourced_proc_status_change,572] launch request org.exelim.flyingbird with pkgname
04-01 21:09:43.138+0900 E/RESOURCED( 2356): proc-main.c: resourced_proc_status_change(577) > [resourced_proc_status_change,577] available memory = 358
04-01 21:09:43.138+0900 D/RESOURCED( 2356): proc-noti.c: safe_write_int(178) > [safe_write_int,178] Response is not needed
04-01 21:09:44.148+0900 D/AUL_AMD ( 2105): amd_launch.c: __grab_timeout_handler(1212) > pid(10790) ecore_x_pointer_ungrab
04-01 21:09:44.148+0900 D/AUL_AMD ( 2105): amd_request.c: __add_history_handler(247) > [SECURE_LOG] add rua history org.exelim.flyingbird /opt/usr/apps/org.exelim.flyingbird/bin/flyingbird
04-01 21:09:44.148+0900 D/RUA     ( 2105): rua.c: rua_add_history(179) > rua_add_history start
04-01 21:09:44.148+0900 D/RUA     ( 2105): rua.c: rua_add_history(247) > rua_add_history ok
04-01 21:09:44.278+0900 I/efl-extension(10792): efl_extension.c: eext_mod_init(39) > Init
04-01 21:09:44.278+0900 D/AUL     (10792): pkginfo.c: aul_app_get_appid_bypid(196) > [SECURE_LOG] appid for 10792 is org.exelim.flyingbird
04-01 21:09:44.278+0900 I/CAPI_APPFW_APPLICATION(10792): app_main.c: ui_app_main(701) > app_efl_main
04-01 21:09:44.278+0900 D/LAUNCH  (10792): appcore-efl.c: appcore_efl_main(1571) > [flyingbird:Application:main:done]
04-01 21:09:44.278+0900 D/AUL     (10792): pkginfo.c: aul_app_get_appid_bypid(196) > [SECURE_LOG] appid for 10792 is org.exelim.flyingbird
04-01 21:09:44.438+0900 D/APP_CORE(10792): appcore-efl.c: __before_loop(1012) > elm_config_preferred_engine_set : opengl_x11
04-01 21:09:44.438+0900 D/AUL     (10792): pkginfo.c: aul_app_get_pkgid_bypid(257) > [SECURE_LOG] appid for 10792 is org.exelim.flyingbird
04-01 21:09:44.438+0900 D/APP_CORE(10792): appcore.c: appcore_init(532) > [SECURE_LOG] dir : /usr/apps/org.exelim.flyingbird/res/locale
04-01 21:09:44.438+0900 D/APP_CORE(10792): appcore-i18n.c: update_region(71) > *****appcore setlocale=en_GB.UTF-8
04-01 21:09:44.438+0900 D/AUL     (10792): app_sock.c: __create_server_sock(136) > pg path - already exists
04-01 21:09:44.438+0900 D/LAUNCH  (10792): appcore-efl.c: __before_loop(1035) > [flyingbird:Platform:appcore_init:done]
04-01 21:09:44.438+0900 I/CAPI_APPFW_APPLICATION(10792): app_main.c: _ui_app_appcore_create(559) > app_appcore_create
04-01 21:09:44.888+0900 D/LAUNCH  (10792): appcore-efl.c: __before_loop(1047) > [flyingbird:Application:create:done]
04-01 21:09:44.888+0900 D/APP_CORE(10792): appcore-efl.c: __check_wm_rotation_support(752) > Disable window manager rotation
04-01 21:09:44.888+0900 D/APP_CORE(10792): appcore.c: __aul_handler(423) > [APP 10792]     AUL event: AUL_START
04-01 21:09:44.888+0900 D/APP_CORE(10792): appcore-efl.c: __do_app(470) > [APP 10792] Event: RESET State: CREATED
04-01 21:09:44.888+0900 D/APP_CORE(10792): appcore-efl.c: __do_app(496) > [APP 10792] RESET
04-01 21:09:44.888+0900 D/LAUNCH  (10792): appcore-efl.c: __do_app(498) > [flyingbird:Application:reset:start]
04-01 21:09:44.888+0900 I/CAPI_APPFW_APPLICATION(10792): app_main.c: _ui_app_appcore_reset(642) > app_appcore_reset
04-01 21:09:44.888+0900 D/APP_SVC (10792): appsvc.c: __set_bundle(161) > __set_bundle
04-01 21:09:44.888+0900 D/LAUNCH  (10792): appcore-efl.c: __do_app(501) > [flyingbird:Application:reset:done]
04-01 21:09:44.888+0900 E/PKGMGR_INFO(10792): pkgmgrinfo_appinfo.c: pkgmgrinfo_appinfo_get_appinfo(1327) > (appid == NULL) appid is NULL
04-01 21:09:44.888+0900 I/APP_CORE(10792): appcore-efl.c: __do_app(507) > Legacy lifecycle: 0
04-01 21:09:44.888+0900 I/APP_CORE(10792): appcore-efl.c: __do_app(509) > [APP 10792] Initial Launching, call the resume_cb
04-01 21:09:44.888+0900 I/CAPI_APPFW_APPLICATION(10792): app_main.c: _ui_app_appcore_resume(624) > app_appcore_resume
04-01 21:09:44.888+0900 D/APP_CORE(10792): appcore.c: __aul_handler(426) > [SECURE_LOG] caller_appid : (null)
04-01 21:09:44.888+0900 D/APP_CORE(10792): appcore-efl.c: __show_cb(826) > [EVENT_TEST][EVENT] GET SHOW EVENT!!!. WIN:1c00003
04-01 21:09:44.888+0900 D/APP_CORE(10792): appcore-efl.c: __add_win(672) > [EVENT_TEST][EVENT] __add_win WIN:1c00003
04-01 21:09:47.588+0900 D/AUL     (10792): pkginfo.c: aul_app_get_appid_bypid(196) > [SECURE_LOG] appid for 10792 is org.exelim.flyingbird
04-01 21:09:52.638+0900 W/CRASH_MANAGER(10796): worker.c: worker_job(1189) > 1110792666c79145951259
